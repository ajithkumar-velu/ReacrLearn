...
const Header = () => {
  return (
    <div className="bg-hero-pattern1 items-center md:pl-0 pl-8 w-full h-[80vh] bg-no-repeat flex flex-col justify-center gap-4 bg-left sm:bg-center bg-cover rounded-2xl mt-[120px]">
        ...
        <a className="px-8 flex gap-2 text-white font-mono rounded-lg py-3 bg-green-400 hover:scale-105 transition-all duration-300 cursor-pointer" >Rent Now <img src={image.arrow_icon} alt="" /> </a>
    </div>
  )
}
